...
function JoinMeeting() {
  ...
  const appID = 1342503877;
  const secretID = "57012fe713231c1203e5a8507b0c7324";
  ...
  const myMeeting = async (element: any) => {
    const kitToken = ZegoUIKitPrebuilt.generateKitTokenForTest(
      ...
      secretID,
      params.id as string,
      user.uid ? user.uid : genrateMeetingID(),
      user.displayName ? user.displayName : genrateMeetingID()
    );
